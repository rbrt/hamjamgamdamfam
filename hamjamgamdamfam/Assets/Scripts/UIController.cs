...
public class UIController : MonoBehaviour {
	...
	void Update () 
	{
		...
		//reticleRect.anchoredPosition = Vector2.SmoothDamp(reticleRect.anchoredPosition, targetReticlePosition, ref reticleVelocity, 10f, maxSpeed: 10, deltaTime: Time.deltaTime);
		reticleRect.anchoredPosition = Vector2.MoveTowards(reticleRect.anchoredPosition, targetReticlePosition, 50f);
	}

	void GetTargetReticlePosition()
	{
